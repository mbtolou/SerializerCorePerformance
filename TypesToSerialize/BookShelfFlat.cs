...
namespace SerializerCore.Serializers
{
    ...
    public struct BookShelfFlat : IFlatbufferObject
    {
        ...
        public SerializerCore.Serializers.BookFlat? Books(int j) { int o = __p.__offset(4); return o != 0 ? (SerializerCore.Serializers.BookFlat?)(new SerializerCore.Serializers.BookFlat()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        ...
        public static VectorOffset CreateBooksVector(FlatBufferBuilder builder, Offset<SerializerCore.Serializers.BookFlat>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateBooksVectorBlock(FlatBufferBuilder builder, Offset<SerializerCore.Serializers.BookFlat>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        ...
        public static Offset<SerializerCore.Serializers.BookShelfFlat> EndBookShelfFlat(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SerializerCore.Serializers.BookShelfFlat>(o);
        }
        public static void FinishBookShelfFlatBuffer(FlatBufferBuilder builder, Offset<SerializerCore.Serializers.BookShelfFlat> offset) { builder.Finish(offset.Value); }
        public static void FinishSizePrefixedBookShelfFlatBuffer(FlatBufferBuilder builder, Offset<SerializerCore.Serializers.BookShelfFlat> offset) { builder.FinishSizePrefixed(offset.Value); }
    };
