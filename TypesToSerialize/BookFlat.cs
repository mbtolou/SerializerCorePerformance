...
namespace SerializerCore.Serializers
{
    ...
    public struct BookFlat : IFlatbufferObject
    {
        ...
        public static Offset<SerializerCore.Serializers.BookFlat> CreateBookFlat(FlatBufferBuilder builder,
        ...
        public static Offset<SerializerCore.Serializers.BookFlat> EndBookFlat(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SerializerCore.Serializers.BookFlat>(o);
        }
    };
